package com.app.pgbooking.ui.firstlogin;
...
public class UserFirstLoginActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_first_login, menu);
        return true;
    }
        ...
        switch (item.getItemId()) {
            case R.id.done:
                ...
                if (firebaseUser != null) {
                    ...
                    values.put(Constants.FIREBASE_USERS_MOBILE, mobileEditText.getText().toString());
